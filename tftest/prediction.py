...
from tftest.prediction_train import train, predict
...
model_path = '/home/wingsby/test/model6'  # 恢复网络结构
    ...
    for i in range(100):
        ...
        for k in range(batch_size):
            ...
            for j in range(30):
                ...
                ori = resizeImg(images_data[k, 31 + j, :, :])
                fore= resizeImg(np.reshape(gen[j][k,:,:],[width,height]))
